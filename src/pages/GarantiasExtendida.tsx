...
import { getGarantias, GarantiaItem } from '@/utils/garantiasApi';
import { getLojas } from '@/utils/cadastrosApi';
import { calcularTempoRestante, getAdesoesPendentes } from '@/utils/garantiaExtendidaApi';
  ...
  return (
    <GarantiasLayout title="Garantia Extendida">
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Acompanhamento de Vencimentos</CardTitle>
          </CardHeader>
          <CardContent>
